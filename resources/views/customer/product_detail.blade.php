...
<div class="container" style="margin-top:80px;">
    <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
        ...
        <a href="http://localhost:8080/ShopNNP/public/product/category/{{$product->category->name}}/{{$product->category->id}}" class="stext-109 cl8 hov-cl1 trans-04">
                ...
                <div class="p-l-25 p-r-30 p-lr-0-lg">
                    <div class="wrap-slick3 flex-sb flex-w">
                        ...
                        <div class="slick3 gallery-lb">
                            @foreach($product->getArrayImage($product->id) as $image)
            ...
            <div class="col-md-6 col-lg-5 p-b-30">
                <div class="p-r-50 p-t-5 p-lr-0-lg">
                    ...
                    <div class="row" style="justify-content: right;">
                        <h4 style="margin-top:10px;margin-right:40px;"><del>{{number_format($product->price, 0, ',', '.')}} đ</del></h4>
                    </div>
                    <div class="row " style="justify-content: right;">
                        <h4 style="margin-top:10px;margin-right:40px;color:red;">{{number_format($product->price_sale, 0, ',', '.')}} đ</h4>
                    </div>
                    @else
                    <div class="row" style="justify-content: right;">
                        <h4 style="margin-top:10px;margin-right:40px;float:right;color:red;">{{number_format($product->price, 0, ',', '.')}} đ</h4>
                    </div>
                    @endif
                    <!--  -->
                    <div class="p-t-33">
                ...
                <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="{{$product->image}}" alt="IMG-PRODUCT" style="height:250px;">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                <a href="http://localhost:8080/ShopNNP/public/product/productdetail/{{$product->id}}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                    {{$product->name}}
                                </a>
                                ...
                                <span class="stext-105 cl3">
                                    @if($product->price_sale !=null)
                                    <div class="row" style="justify-content: right;">
                                        <h6 style="margin-top:10px;margin-left:15px;"><del>{{number_format($product->price, 0, ',', '.')}} đ</del></h6>
                                    </div>
                                    <div class="row " style="justify-content: right;">
                                        <h6 style="margin-top:10px;color:red;margin-left:15px;">{{number_format($product->price_sale, 0, ',', '.')}} đ</h6>
                                    </div>
                                    @else
                                    <div class="row" style="justify-content: right;">
                                        <h6 style="margin-top:10px;float:right;color:red;margin-left:15px;">{{number_format($product->price, 0, ',', '.')}} đ</h6>
                                    </div>
                                    @endif
                                </span>
                            </div>
