...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html"><b>Shop</b>NNP</a>
  </div>
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      @include('admin.alert')
      <form action="{{url('Admin/user/register/store/add')}}" method="POST">
        @csrf
      <input type="text" class="form-control d-none" name='type_id' value="2" >
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Tên đăng nhập" name='name' value="{{old('name')}}">
