...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/ShopNNP/public/Admin/css/print.css" media="print">
</head>
    ...
    <div class="wrapper">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/ShopNNP/public/Admin/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/ShopNNP/public/Admin/dist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        John Pierce
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                                <img src="/ShopNNP/public/Admin/dist/img/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                                <div class="media-body">
                                    <h3 class="dropdown-item-title">
                                        Nora Silvester
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="/ShopNNP/public/Admin/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('adminAddProduct')}}" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="{{route('adminListSlider')}}" class="nav-link">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('adminAddSlider')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Thêm slider</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{route('adminListDiscount')}}" class="nav-link">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('adminAddDiscount')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
        ...
        <footer class="main-footer">
            <div class="float-right d-none d-sm-block">
                <strong><a href="{{route('home')}}">ShopNNP &copy;</a></strong>
            </div>
        </footer>
